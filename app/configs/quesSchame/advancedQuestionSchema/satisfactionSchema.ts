...
import Scale from "~/components/quesComs/advancedQuestion/scale.vue";
import Satisfaction from "~/components/quesComs/advancedQuestion/satisfaction.vue";
export default function satisfactionSchema() {
  //对应组件
  return {
    name: "satisfaction" as const,
    id: uuidv4(),
    type: markRaw(Satisfaction),
    state: {
      title: {
        id: uuidv4(),
        status: "满意度默认标题",
