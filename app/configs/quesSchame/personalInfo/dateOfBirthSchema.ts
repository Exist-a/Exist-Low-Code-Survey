...
import dateOfBirth from "~/components/quesComs/personalInfo/dateOfBirth.vue";
export default function dateOfBirthSchema() {
  //对应组件
  return {
    name: "date-of-birth" as const,
    id: uuidv4(),
    type: markRaw(dateOfBirth),
    state: {
      title: {
        id: uuidv4(),
        status: "生日默认标题",
